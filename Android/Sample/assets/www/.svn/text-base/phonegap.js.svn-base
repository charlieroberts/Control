...
PhoneGap.exec = function() {
    ...
    if (PhoneGap.queue.timer == null)
        PhoneGap.queue.timer = setInterval(PhoneGap.run_command, 1);
};
/**
...
UIControls.prototype.removeToolBar = function() {
	PhoneGap.exec("UIControls.removeToolBar");
};
