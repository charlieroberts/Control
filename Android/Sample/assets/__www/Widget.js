...
function Widget(ctx, props) { // x, y, width, height, color, startingValue, stroke, protocol) {
	console.log("widget start " + props.name);
	if(ctx != null) {
		console.log("context != null " + props.name);
		...
		console.log("props.width :: " + props.width + " | props.height :: " + props.height);	
		...
		console.log("bounds set " + props.name);
		...
		if(props.name == "refreshButton") console.log("after type / channel / number");
		...
		console.log("widget end " + props.name);
	}		
