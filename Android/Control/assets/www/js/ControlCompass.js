...
ControlCompass.prototype_onCompassUpdate = function(_heading) {
...
ControlCompass.prototype.event = function() {}
    
function onError() {
    alert('Error: failed to get heading!');
};

ControlCompass.prototype.draw = function() {}
	
ControlCompass.prototype.start = function() {
...
ControlCompass.prototypeunload = function() {
    //PhoneGap.exec("Compass.stop", null);
    navigator.compass.clearWatch(this.watchID);
}
	
ControlCompass.prototype.setUpdateRate = function(rateInHz) {
