...
- (NSDictionary*) deviceProperties:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options
{
	...
	[devProps setObject:STRF(@"%f",del.window.frame.size.width) forKey:@"width"];
	[devProps setObject:STRF(@"%f",del.window.frame.size.height) forKey:@"height"];	
...
- (void) setRotation:(NSMutableArray*)arguments withDict:(NSMutableDictionary*)options {
	...
	[(PhoneGapViewController *)del.viewController setRotateOrientation:[arguments objectAtIndex:0]];
